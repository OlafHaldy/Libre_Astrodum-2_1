...
def build_lunar_prompt(
    ...
    """
    Отдельный промпт для Лунара.
    Фокус на эмоциональный фон месяца.
    """
    ...
    parts = [
        ...
        "Пиши как лунный вестник — кратко и проникновенно.",
        "",
        _build_chart_metadata(chart, chart_type),
        "",
        _build_composition_summary(composition),
        ...
        "",
        "СТИЛЬ:",
        "- Русский язык, философский, мягкий.",
...
def build_solar_prompt(
    ...
    """
    Отдельный промпт для Соляра.
    Фокус на тематику года.
    """
    ...
    parts = [
        ...
        "",
        "СТИЛЬ:",
        "- Русский язык, философский, уверенный.",
