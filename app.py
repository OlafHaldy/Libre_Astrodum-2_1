...
Твоя задача — создать ОДНУ короткую афористическую фразу для знака {sign_ru}
на тему: {topic}.
...
Если одну и ту же фразу можно без изменений дать четырём или более
другим знакам — считай её неудачной и перепиши.

АФОРИЗМ ДОЛЖЕН БЫТЬ КОНКРЕТНЫМ

Не стремись сделать фразу максимально глубокой или возвышенной.

Предпочтительнее одна точная мысль, наблюдение или парадокс,
чем абстрактное рассуждение о судьбе, времени, душе или бытии.

Фраза должна создавать ощущение:
«Да, именно это — про этот знак».

Избегай чрезмерно абстрактных конструкций,
в которых невозможно представить человека, ситуацию или действие.

Если фраза звучит как цитата неизвестного философа о мироздании,
сделай её конкретнее.
...
Используй соответствующее ядро выбранного знака как основу.
...
Ключевой вопрос: что мы пытаемся удержать, хотя всё равно придётся отпустить?
...
Ключевой вопрос: что происходит, когда мыслей становится больше, чем ответов?
...
Ключевой вопрос: когда исправление мира становится невозможностью жить в нём?
...
избегание конфликта.
Ключевой вопрос: сколько равновесия нужно потерять, чтобы наконец выбрать?
...
Ключевой вопрос: что должно умереть, чтобы стало возможным новое?
...
Ключевой вопрос: что останется от истины, если перестать в неё верить?
...
Ключевой вопрос: зачем взбираться на вершину, если некому будет смотреть?

ВОДОЛЕЙ:
Будущее, свобода, идея, новое, отчуждение, человечество,
разрыв со старыми формами.
Внутреннее противоречие: желание принадлежать человечеству
против ощущения себя чужим среди людей.
Также: стремление изменить мир
против невозможности заставить мир измениться по своей воле.
Теневая сторона: холодность, отстранённость, интеллектуальное превосходство,
бегство в идеи вместо близости.
Ключевой вопрос: что происходит с человеком, который слишком рано увидел будущее?
...
размытые границы.
Ключевой вопрос: где заканчивается сострадание и начинается исчезновение себя?
...
Пусть читатель почувствует характеристику через саму мысль.
==================================================
ЕДИНСТВО МЫСЛИ
==============
...
Не создавай конструкцию, в которой первая половина и вторая
половина могли бы существовать как отдельные афоризмы.

Вторая часть фразы должна быть неизбежным следствием первой,
а не новым красивым образом.

Если удалить вторую часть, первая должна оставлять вопрос,
на который вторая отвечает.

Если удалить первую часть, вторая не должна сохранять
самостоятельный смысл.

НЕ ИСПОЛЬЗУЙ противопоставление только ради ритма.

Плохо:
«Попытка изменить мир — случайный бросок, судьба —
ответ, который мир не слышит».

Здесь два независимых образа, соединённых тире.
...
а как мысль, которую невозможно разделить на две независимые фразы.
...
Фраза должна быть красивой, но красота не должна заменять мысль.
