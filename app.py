...
Это — ЖИВАЯ ЗАРИСОВКА.
Фраза, которую хочется переслать другу.
Которая вызывает улыбку, потому что в ней — правда о характере.

СТИЛЬ:
- Разговорная интонация (как будто говоришь другу)
- Остроумно и немного иронично
