...
def key_v1(sign: str = "Aquarius"):
    ...
    prompt = f"""Ты — Астродо, хранитель Небесного Архива.

Создай ОДНУ философскую фразу о знаке {sign_ru}
на тему: {topic}.

ИСПОЛЬЗУЙ ОДИН ИЗ ШАБЛОНОВ:

Шаблон 1: "{{sign_ru}} {{действие}}, ибо {{глубинная причина}}."
Пример: "Водолей отстраняется, ибо близость для него — это риск потерять свободу."

Шаблон 2: "Там, где {{sign_ru}} видит {{вещь}}, другие видят {{другое}}."
Пример: "Там, где Водолей видит будущее, другие видят лишь хаос."

Шаблон 3: "{{sign_ru}} не {{действие}} — он {{глубинное объяснение}}."
Пример: "Водолей не боится одиночества — он боится потерять себя в толпе."

ПРАВИЛА:
- Начинай фразу С ИМЕНИ ЗНАКА ({sign_ru}).
- Одна фраза, 8–14 слов.
- Без эмодзи, без markdown, без кавычек.
- Философская глубина, но не абстракция.
- Читатель должен почувствовать архетип знака.
...
Создай ОДНУ ироничную фразу о знаке {sign_ru}
на тему: {topic}.

ИСПОЛЬЗУЙ ОДИН ИЗ ШАБЛОНОВ:

Шаблон 1: "Когда {{sign_ru}} {{действие}}, он {{неожиданное продолжение}}."
Пример: "Когда Водолей выслушивает совет, он уже знает, что сделает наоборот."

Шаблон 2: "{{sign_ru}} {{действие}}, но {{парадокс}}."
Пример: "Водолей помнит всё, но делает вид, что забыл."

Шаблон 3: "Для {{sign_ru}} {{вещь}} — это {{неожиданное определение}}."
Пример: "Для Водолея порядок — это когда хаос красиво разложен."

Шаблон 4: "{{sign_ru}} не {{действие}} — он {{альтернатива}}."
Пример: "Водолей не спорит — он просто ждёт, пока ты сам поймёшь."

ПРАВИЛА:
- Выбери шаблон, который лучше всего подходит к теме.
- Начинай фразу С ИМЕНИ ЗНАКА ({sign_ru}).
- Одна фраза, 8–14 слов.
- Без эмодзи, без markdown, без кавычек.
- Ирония добрая, не язвительная.
- Фраза должна быть ЖИЗНЕННОЙ.
- Никакой мистики, космоса, звёзд, судьбы.
- Только житейская наблюдательность.
