...
Это внутреннее распределение вероятностей.
...
2. Он возник из архетипа {sign_ru}, а не из общей философии?
3. Связан ли он с темой {topic}?
4. Можно ли узнать архетип знака, не видя его названия?
5. Можно ли без изменений отдать эту фразу четырём другим знакам?
   Если да — перепиши.
6. Не использует ли фраза банальную эзотерическую метафору?
7. Есть ли в ней самостоятельная мысль?
8. Не описывает ли она знак вместо того, чтобы раскрывать его через образ?
9. Работает ли метафора буквально и логически?
10. Не возникает ли после прочтения естественного вопроса:
    «Но почему он тогда это делает?» или «Как это вообще возможно?»
    
Если образ красивый, но его внутренняя логика нарушена —
перепиши фразу.

Если фраза красивая, но универсальная — перепиши.

Если фраза слишком прямолинейная — преврати характеристику в метафору.

Если фраза слишком заумная — упрости её.

Если фраза использует очевидный ярлык знака — найди более глубокий образ.
